...
//   pybind11_protobuf::RegisterWrappedProtoCasters();
//
...
inline void RegisterWrappedProtoCasters() { InitializePybindProtoCastUtil(); }
...
struct ConstMemberInvoker {
  static_assert(!std::is_base_of_v<::google::protobuf::Message, C>,
